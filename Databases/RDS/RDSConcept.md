...
#### Notes :- 
1.Primary and Stand will be placed in different AZ 
2.Synchronous Replication between Primary and Standby
3.Asynchronous Replication between Standby and Read Replica.
4. Read Replica can be same region or different regions.
